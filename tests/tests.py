...
class TestApp(unittest.TestCase):
    ...
    def test_post_comments_on_different_messages(self):
    ...
    def test_combine_message_filter_search_and_comment(self):
        ...
        response = self.client.post('/', data={'name': 'Test User', 'comment': 'Health comment', 'parent_id': 0}, follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'Health post', response.data)
    ...
    def test_post_message_search_and_post_two_messages(self):
        response = self.client.post('/', data={'name': 'Test User 1', 'post': 'Test Message 1'}, follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        response = self.client.get('/?search=Test')
        self.assertEqual(response.status_code, 200)
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'Test Message 2', response.data)
        response = self.client.post('/', data={'name': 'Test User 3', 'post': 'Test Message 3'}, follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'Test Message 3', response.data)
    ...
    def test_post_message_search_and_post_two_comments(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'Test Comment 1', response.data)
        response = self.client.post('/', data={'name': 'Test User 2', 'comment': 'Test Comment 2', 'parent_id': 0}, follow_redirects=True)
        self.assertEqual(response.status_code, 200)
